...
# CUDA_VISIBLE_DEVICES=1 torchrun --nnodes=$NNODES --master_addr=$MASTER_ADDR --master_port=29400 --node_rank=$NODE_RANK --nproc_per_node=$GPUS trainer.py --model_name pythia-14m --config config_hub/pretrain/debug_new.yaml
# CUDA_VISIBLE_DEVICES=1 torchrun --nnodes=$NNODES --master_addr=$MASTER_ADDR --master_port=29400 --node_rank=$NODE_RANK --nproc_per_node=$GPUS trainer.py --config config_hub/pretrain/debug_infini_moe_mod.yaml
# CUDA_VISIBLE_DEVICES=0 torchrun --nnodes=$NNODES --master_addr=$MASTER_ADDR --master_port=29500 --node_rank=$NODE_RANK --nproc_per_node=$GPUS trainer_rnn.py --config config_hub/pretrain/slstm.yaml
# CUDA_VISIBLE_DEVICES=1 torchrun --nnodes=$NNODES --master_addr=$MASTER_ADDR --master_port=29400 --node_rank=$NODE_RANK --nproc_per_node=$GPUS trainer_rnn.py --config config_hub/pretrain/mlstm.yaml
# CUDA_VISIBLE_DEVICES=0 torchrun --nnodes=$NNODES --master_addr=$MASTER_ADDR --master_port=29300 --node_rank=$NODE_RANK --nproc_per_node=$GPUS trainer_rnn.py --config config_hub/pretrain/mamba.yaml
# CUDA_VISIBLE_DEVICES=1 torchrun --nnodes=$NNODES --master_addr=$MASTER_ADDR --master_port=29400 --node_rank=$NODE_RANK --nproc_per_node=$GPUS trainer.py --config config_hub/pretrain/mamba.yaml
