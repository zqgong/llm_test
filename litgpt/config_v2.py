...
class Config:
    ...
    use_infini_transformer: bool = False
    segment_len: int = 2048
    use_delta_update_memory: bool = False
    init_learnable_memory_state: bool = False

    use_mod: bool = False
    capacity: float = 0.125

    mlstm_projection_factor: int = 2
    rnn_type: Literal["sLSTM", "mLSTM", "xLSTM[1:1]", "Mamba", None] = None
