...
DEFAULT_IMAGE_CHUNK = "<Img><image></Img>"
...
CONV_VISION_LLama2_video = Conversation(
    system="Give the following video: <vid_start>VideoContent<vid_end>. "
...
class Chat:
    ...
    def upload_img(self, image, conv, img_list):
        conv.append_message(conv.roles[0], DEFAULT_IMAGE_CHUNK)
